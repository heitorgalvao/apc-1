...
int main() {
    ...
    // Nome do arquivo para o placar (ainda presente, mas não será lido para zerar)
    ...
    while (1) {
        ...
        switch (escolha_menu) {
            case 1: { // Novo Jogo
                ...
                // O placar é salvo APENAS para registrar as vitórias/empates da SESSÃO ATUAL.
                // Na próxima execução, ele será zerado novamente.
                ...
                if (arquivo != NULL) {
                    ...
                    printf("Erro: Nao foi possivel salvar o placar temporariamente.\n");
                }
            ...
            case 2: { // Ver Placar
                system("clear");
                printf(BLU);
                printf("--- PLACAR GERAL (Sessão Atual) ---\n");
